...
export default class FormInput extends Component {
    ...
    _handleSubmit = (e) => {
        const {txtWard,txtNameOfShop, txtTypeOfShop, txtPhoneNumber, txtOpenTime, txtCloseTime, txtStreet,
            txtDistrict, txtMinPrice, txtMaxPrice, txtDescription, ckMon, ckTue, ckWed, ckThu, ckFri, ckSat, ckSun, imageArray, avartarImage
        } = this.state
        this.setState({
            formError:
                {
            ...
            async () => {
                ...
                if (isOkay) {
                    ...
                    await this.props.onCreateStore(txtNameOfShop,txtDescription,txtDistrict,txtWard,txtStreet,txtPhoneNumber,
                        ...
                        txtCloseTime,Number (ckMon),Number (ckTue),Number (ckWed),Number (ckThu),Number (ckFri),Number (ckSat),Number(ckSun), sendImage,()=>{
            ...
            <Fragment>
                <form onSubmit={this._handleSubmit}>
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                    onBlur ={()=> {this.setState ({
                                        formError: {
                                            ...this.state.formError,
                                        txtDescription: checkLengthInput(this.state.txtDescription, 8),
                                        }
                                    })}}
                                    type="text"
                                    class="form-control"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for=""><strong>Avartar Picture of Shop: </strong></label>
                                <div class="row">
